...
module.exports = async (req, res) => {
    ...
    // bcrypt.compare을 활용하여 요청받은 비밀번호와 해시값으로 저장된 비밀번호를 비교
    ...
    if (!checkPassword) {
      ...
      // const accessToken = jwt.sign(??, process.env.ACCESS_SECRET, { expiresIn: "1d" })
      // const refreshToken = jwt.sign(??, process.env.REFRESH_SECRET, { expiresIn: "3d" })
